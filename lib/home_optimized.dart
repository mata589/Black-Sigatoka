...
//         String favoriteFoodsString =
//             userSnapshot.data()!['favorite_foods'] as String;
//         setState(() {
//           _favoriteFoods = favoriteFoodsString
//               .split(',')
//               .map((food) => food.trim())
//               .toList();
//         });
...
//   List<QueryDocumentSnapshot> _filteredFoodItems(
//       List<QueryDocumentSnapshot> foodItems) {
//     if (_searchQuery.isEmpty) {
//       return foodItems;
//     }

//     return foodItems
//         .where((foodItem) => (foodItem['item_name'] as String? ?? '')
//             .toLowerCase()
...
//                       var foodData = filteredFoodItems[index].data()
